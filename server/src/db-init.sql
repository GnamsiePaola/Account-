...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `business_tracker`;
...
-- --------------------------------------------------------
-- Tables simplifiées pour compatibilité avec l'interface actuelle
-- --------------------------------------------------------
...
-- Sample user
INSERT INTO `user` (username, email, password, userid) 
VALUES ('admin', 'admin@example.com', 'admin123', 'USR001');

-- Sample business
INSERT INTO `Business` (idBusiness, BusinessName, contact, user_userid)
VALUES (1, 'My Business', '+1234567890', 'USR001');

-- Sample transactions data
INSERT INTO `transactions` (type, category, amount, description, date)
VALUES 
('income', 'sales', 75000, 'Product sales', NOW()),
('expense', 'feed', 25000, 'Monthly supplies', NOW()),
('income', 'services', 50000, 'Consulting services', NOW()),
('expense', 'utilities', 15000, 'Electricity bill', NOW());

-- Sample inventory data
INSERT INTO `inventory` (name, category, quantity, unit_cost, description)
VALUES 
('Product A', 'electronics', 100, 500, 'High quality product'),
('Product B', 'clothing', 200, 300, 'Premium material'),
('Product C', 'food', 50, 1000, 'Organic items'),
('Product D', 'stationery', 300, 150, 'Office supplies');
